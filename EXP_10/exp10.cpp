...
cout<<setw(2)<<left<<prod_id<<setw(10)<<right<<prod_name<<setw(10)<<right<<prod_price<<setw(10)<<right<<gst<<setw(10)<<right<<stock<<setw(10)<<right<<discount;
...
void Cart::DisplayBill(){
	...
	if(n==NULL)
    	...
    	{
    	    cout<<"-------------------------------------"<<left<<""<<setw(15)<<left<<"PRODUCT DETAIL"<<"--------------------------------------"<<endl;
cout<<setw(2)<<left<<"ID"<<setw(10)<<right<<"NAME"<<setw(10)<<right<<"PRICE"<<setw(10)<<right<<"GST"<<setw(10)<<right<<"STOCK"<<setw(10)<<right<<"DISCOUNT"<<setw(10)<<right<<"QUANTITY"<<setw(10)<<right<<"TOTAL"<<endl;
cout<<setw(69)<<endl;
cout<<"------------------------------------------------------------------------------------------"<<endl;
    	    Node *ptr;
    	    ptr=n;
	    ...
	    cout<<setw(91)<<left<<setfill('-')<<"\n"<<endl;
	cout<<"                                   "<<"\u2660 VISIT AGAIN \u2660"<<endl;
	cout<<endl<<"                             Developed By\u00A9 Swarup More(21UCS308)"<<endl;
	cout<<setw(91)<<left<<setfill('-')<<"\n"<<endl;
    	}
}
...
int main(){
	...
	while(1){
		...
		if(choice == 1){
			...
			cout<<endl<<"                                Copyright \u00A9 Swarup More(21UCS308)"<<endl;
			exit(0);
		}
		else{
